...
import com.kcj_customer_be.security.service.TokenAuthenticationUserDetailsService;
   ...
   public void configure(HttpSecurity builder) throws Exception {
      ...
      var jwtAuthenticationFilter = new AuthenticationFilter(
            ...
            new JwtAuthenticationConverter(
                  this.accessTokenStringDeserializer, this.refreshTokenStringDeserializer));
