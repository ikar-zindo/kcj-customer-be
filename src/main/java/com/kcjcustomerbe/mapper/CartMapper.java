...
public interface CartMapper {
   ...
   /**
    * Updates an existing `Cart` entity from a `CartDto`.
    *
    * @param dto The `CartDto` with updated information.
    * @param entity The existing `Cart` entity to be updated.
    */
   void updateCartFromDto(CartDto dto, @MappingTarget Cart entity);

   /**
    * Updates an existing `CartProduct` entity from a `CartProductDto`.
    *
    * @param dto The `CartProductDto` with updated information.
    * @param entity The existing `CartProduct` entity to be updated.
    */
