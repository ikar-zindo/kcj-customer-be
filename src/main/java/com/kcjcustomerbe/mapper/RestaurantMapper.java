...
public interface RestaurantMapper {
   ...
   /**
    * Maps an {@link RestaurantDto} to an {@link Restaurant} entity.
    *
    * @param dto The {@link RestaurantDto} to be mapped.
    * @return The mapped {@link Restaurant} entity. If the source {@link RestaurantDto} is null, return null.
    */
   @Mappings({
         @Mapping(target = "id", source = "id"),
         @Mapping(target = "name", source = "name"),
   ...
   /**
    * Maps a list of {@link Restaurant} entities to a list of {@link RestaurantDto}.
    *
    * @param entities The list of {@link Restaurant} entities to be mapped.
    * @return The list of mapped {@link RestaurantDto}. If the source list is null or empty, return an empty list.
    */
